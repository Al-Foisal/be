                        ...
                        <form action="{{ route('admin.storeCompanyInfo') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="exampleInputFile">Wallet Logo</label>
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="form-control" name="wallet"
                                                        id="exampleInputFile">
                                                </div>
                                            </div>
                                            @if (!empty($info->wallet))
                                                <img src="{{ asset($info->wallet) }}" height="100" width="200" alt="">
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="wallet_link" class="form-control" rows="2"
                                        placeholder="Enter App Link">{{ $info->wallet_link ?? '' }}</textarea>
                                </div>
