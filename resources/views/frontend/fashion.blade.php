    ...
    <div class="container">
        <main class="main">
            @if ($fashion->count() > 0)
                <div class="container">
                    <div class="row">
                            <div class="home-slider 5col category-home-slider owl-carousel owl-theme owl-carousel-lazy"
                                        data-owl-options="{
                                                                'nav': false,
                                                                'autoPlay': true,
                                                                'dots':false
