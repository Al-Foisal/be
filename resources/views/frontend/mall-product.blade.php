...
@section('title', 'Bazarkaart Mall Product')
@section('css')
    <style>
...
@section('content')
    <main class="main mb-5 mt-2">
        @if ($bazar_mall->count() > 0)
        ...
        @endif
        <div class="container-fluide bg-white pt-2">
            <div class="row" style="width: 95%;margin:auto;">
                <div class="products-slider 5col owl-carousel owl-theme" data-owl-options="{
                    ...
                    @foreach ($brands as $mall)
                        <div class="product-default" style="margin: 2rem;">
                            <figure>
